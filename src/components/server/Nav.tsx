...
export default async function Nav() {
  // const url = `${process.env.NEXT_PUBLIC_CMS_API_URL}/global?populate[0]=navigation&populate[1]=navigation.items&populate[2]=navigation.items.page&populate[3]=footer`;
